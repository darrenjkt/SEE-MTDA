...
if __name__ == "__main__":
    ...
    with open('/SEE-MTDA/see/coco_categories.json','r') as f:
    ...
    for idx, imgname in tqdm(enumerate(img_list), total=len(img_list), colour='yellow', desc='Inference'):        
        tic = time.time()
        ...
        segm_json_result = segm2json(result, class_ids, score_thresh=0.3, mask=args.instance_mask)
