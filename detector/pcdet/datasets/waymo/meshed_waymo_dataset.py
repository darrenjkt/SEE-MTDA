...
class MeshedWaymoDataset(DatasetTemplate):
    ...
    def get_meshed_lidar(self, sequence_name, sample_idx):
        """
        ...
        """
        meshed_lidar_file = self.data_path / sequence_name / ('%04d.pcd' % sample_idx)
    ...
    def __getitem__(self, index):
        ...
        points = self.get_meshed_lidar(sequence_name, sample_idx)
