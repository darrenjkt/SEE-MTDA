...
class KittiDataset(DatasetTemplate):
    ...
    def __getitem__(self, index):
        ...
        if 'annos' in info:
            ...
            # Add a filter for minimum points in training. Note that this will not filter out the gt_annos
            # in testing. For that, edit the evaluation function
            if self.dataset_cfg.get('FILTER_MIN_POINTS_IN_GT', False)  and self.training:
                print(f'Removing gt with points less than {self.dataset_cfg.FILTER_MIN_POINTS_IN_GT}')
